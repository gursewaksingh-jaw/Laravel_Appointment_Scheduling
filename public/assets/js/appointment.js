...
next.addEventListener("click", () => {
    if (currentActive == 2) {
        var secondform = checkSecondFormValidation();
        if (secondform == true) {
            update();
            shoeStep();
            currentActive++;
            console.log("3=>", currentActive);
            if (currentActive == 3) {
                seeData('#step3');
                update();
                shoeStep();
...
//         if (response == true) {
//             console.log("first current active",currentActive);
//             currentActive++;
//             console.log("2nd current active",currentActive);

//             if(currentActive == 2){
//                 update();
//                 shoeStep();
//                 currentActive++
//                 console.log("3rd Current Active ",currentActive);
//             }
//             if(currentActive == 3){
//                 shoeStep();
//                 console.log("Last Page",currentActive);
//             }
//         }
//     }
//     // if(currentActive == 3){
...
//     //     shoeStep();
//     //     // currentActive++
//     //     // console.log("sdbhjbdhjbdshv",currentActive);
//     //     // if(currentActive == 3){
//     //     //     update();
//     //     //     console.log("open last step ",currentActive)
//     //     // }
//     // }
//     // if (currentActive == 3) {
...
function checkSecondFormValidation() {
    ...
    console.log("h_id", hospital_id);
    var date = $('input[name=date]').val();
    console.log("h_date", date);
    var time = $('input[name=time]').val();
    console.log('h_time', time);
