    ...
    <div class="xl:w-3/4 mx-auto">
        <div class="xxsm:mx-5 xl:mx-0 2xl:mx-0">
            <div class="xxsm:pt-5 xxsm:pb-5 justify-between flex sm:flex-row xxsm:flex-col">
                <div>
                    <a href="{{ url('/') }}" class="">
                        <img src="{{asset('logo/twslogo.png')}}" width="150px" height="40px" alt="Logo">
                    </a>
                    <div class="flex pt-5">
        ...
        <div class="border-t border-gray pb-5 xxsm:mx-5 xl:mx-0 2xl:mx-0">
            <div class="xxsm:pt-5 justify-between flex sm:flex-row xxsm:flex-col">
                <p class="text-white text-base font-normal leading-5 font-fira-sans mb-5">{{__('Copyright')}} &copy; {{ Carbon\Carbon::now(env('timezone'))->year }} TWS Product {{__(', All rights reserved')}} </p>
