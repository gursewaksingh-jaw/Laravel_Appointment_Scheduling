...
<div class="pt-14 border-b border-white-light mb-10 pb-10">
    ...
    <div class="flex justify-center 2xl:flex-row xl:flex-row xlg:flex-row lg:flex-row xmd:flex-row md:flex-row sm:flex-row msm:flex-col xsm:flex-col xxsm:flex-col space-x-5
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block p-2 pl-10 text-sm text-gray-100 bg-white-50 border border-white-light 2xl:w-96 xmd:w-72 sm:w-60 msm:w-96 xsm:w-60 h-12" placeholder="Search Doctor..." required>
        </div>
        <button type="button" class="text-white bg-primary text-center px-6 py-2 text-base font-normal leading-5 font-fira-sans sm:w-32 msm:w-32 xsm:w-32 xxsm:w-32 h-12"><i class="fa-solid fa-magnifying-glass"></i> {{__('Search')}}</button>
    </div>
</div>
