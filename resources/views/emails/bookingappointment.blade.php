                                            ...
                                            <tr>
                                                <td style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="mainTitle">
                                                    <h4 class="text" style="color:#5a4f4f;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:24px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:26px;text-transform:none;text-align:left;padding:0;margin:0">
                                                        Hi,<span style="color:#146C94;">{{$doctorname}}</span>
                                                    </h4>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="padding-bottom: 20px;" align="center" valign="top" class="description">
                                                                    <h4 class="text" style="color:#5a4f4f;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:22px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:26px;text-transform:none;text-align:left;padding:0;margin:0"> {{$patientname}}, has Booked Appointment on {{$slotdate}} at {{$slottime}}</h4>
                                                                </td>

                                                            </tr>
                                                            <tr>
                                                                <td style="padding-bottom: 20px;" align="center" valign="top" class="description">
                                                                    <h4 class="text" style="color:#5a4f4f;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:22px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:26px;text-transform:none;text-align:left;padding:0;margin:0"> Please Let Him Know Your Response that you accepted or canceled his appointment, so that he/she can reschedule .</h4>
                                                                </td>

                                                            </tr>
                                                            <tr>
                                                                <td style="padding-bottom: 20px;" align="center" valign="top" class="description">
                                                                    <h4 class="text" style="color:#5a4f4f;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:22px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:26px;text-transform:none;text-align:left;padding:0;margin:0"> Thanks From TWS DOCTRO </h4>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
